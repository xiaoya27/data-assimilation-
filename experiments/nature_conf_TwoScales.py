...
GeneralConf['ExpName']='TwoScales'                        #Experiment name.
...
ModelConf['Coef']=np.array([20,0,0])                    #Coefficient of parametrized forcing (polynom coefficients starting from coef[0]*x^0 + coef[1]*x ... ) 
...
ModelConf['FSpaceFreq']     =np.array([1,0,0])          #Use integers >= 1
...
ModelConf['TwoScaleParameters']=np.array([10,10,1])     #Small scale and coupling parameters C , B and Hint
...
ObsConf['Freq']=10                                   #Observation frequency in model time units (will also control nature run output frequency)
...
ObsConf['Error']=0.05                                 #Constant observation error.
